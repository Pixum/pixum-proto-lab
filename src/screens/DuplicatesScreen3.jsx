  ...
  return (
    <div className="du3-screen">
      <div className="du3-navbar">
        ...
        <span className="du3-title">Duplicates</span>
        <div className="du3-back" style={{ visibility: 'hidden' }} />
      </div>

      <div className="du3-scroll">
        <div className="du3-header">
          <div className="du3-step-badge">Step 1 out of 3</div>
          <div className="du3-header-text">
            <h1 className="du3-heading">Duplicates</h1>
            <p className="du3-desc">
              You can review similar photos and select which ones to keep in your photobook
            </p>
          </div>
          <div className="du3-tip">
            ...
            <p className="du3-tip-text">Tap on a photo to ex- or include it from your selection</p>
          </div>
        </div>
                ...
                {group.photos.map((photo, pi) => {
                  ...
                  return (
                    <button key={pi} className={`du3-photo${isExcluded ? ' du3-photo--excluded' : ''}`} onClick={() => onToggle(gi, pi)}>
                      <img src={photo.src} alt="" className="du3-photo-img" />
      ...
      <div className="du3-bottombar">
        <div className="du3-bottombar-inner">
          <button className="du3-cta" onClick={onNext}>Next step</button>
        </div>

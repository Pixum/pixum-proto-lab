    ...
    <div className="fo3-screen">
      ...
      <div className="fo3-scroll">
        <div className="fo3-header">
          <div className="fo3-step-badge">Klasse</div>
          <h1 className="fo3-heading">Finale Auswahl</h1>
          <p className="fo3-desc">
            This is your final Selection. In the next step we will create chapters to structure your photobook. You can change, add or delete images at all steps.
          </p>
        </div>
        ...
        <div className="fo3-grid">
          {photos.map((src, i) => (
            <div key={i} className="fo3-photo">
              <img src={src} alt="" className="fo3-photo-img" />
      ...
      <div className="fo3-bottombar">
        <div className="fo3-bottombar-inner">
          <button className="fo3-cta" onClick={onNext}>Next step</button>
        </div>

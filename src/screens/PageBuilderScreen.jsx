      ...
      <div className="pb-topbar">
        ...
        <div className="pb-toolbar">
          <div className="pb-tool">
            ...
            <span className="pb-tool-label">Fotos hinzufügen</span>
          </div>
          <div className="pb-tool">
            <div className="pb-tool-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <span className="pb-tool-label">Designs</span>
          </div>
          <div className="pb-tool">
            <div className="pb-tool-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <span className="pb-tool-label">Vorschau</span>
          </div>
          <div className="pb-tool">
            <div className="pb-tool-icon">
            ...
            <span className="pb-tool-label">Mehr</span>
          </div>
        </div>
      </div>
      ...
      <div className="pb-bottombar">
        <div className="pb-bottombar-inner">
          <div className="pb-product-info">
            <span className="pb-product-title">Fotobuch</span>

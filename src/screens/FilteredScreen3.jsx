    ...
    <div className="fi3-screen">
      ...
      <div className="fi3-scroll">
        <div className="fi3-header">
          <div className="fi3-step-badge">Step 3 out of 3</div>
          <h1 className="fi3-heading">Unwanted images</h1>
          <p className="fi3-desc">
            Filter for specific objects or locations. We already filtered documents, screenshots, QR-Codes etc.
          </p>
        </div>
          ...
          {photos.map((src, i) => {
            ...
            return (
              <button key={i} className={`fi3-photo${isExcluded ? ' fi3-photo--excluded' : ''}`} onClick={() => onToggle(i)}>
                <img src={src} alt="" className="fi3-photo-img" />
      ...
      <div className="fi3-bottombar">
        <div className="fi3-bottombar-inner">
          <button className="fi3-cta" onClick={onNext}>Next step</button>
        </div>
